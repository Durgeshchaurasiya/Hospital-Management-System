...
const registerUser = async (req, res) => {
    try {
        ...
        if(password.length < 8){
            return res.json({success:false, message:"Password must contain at least 8 character"})
        }
...
// API to get user's appointment on my-appointments page
...
const cancelAppointment = async (req, res) => {
    ...
    try {
        ...
        // verify the user cancelling the appointment

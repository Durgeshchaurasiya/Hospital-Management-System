        ...
        <div className="flex flex-col gap-4 m-5">
          ...
          <div className="flex-1 border border-stone-100 rounded-lg p-8 py-7 bg-white">
            ...
            <div>
              ...
              {
                isEdit ? 
                <button onClick={updateProfile} className="px-4 border border-[#5f6FFF] text-sm rounded-full mt-5 hover:bg-[#5f6FFF] hover:text-white transition-all">Save</button> :
                <button onClick={()=>setIsEdit(true)} className="px-4 border border-[#5f6FFF] text-sm rounded-full mt-5 hover:bg-[#5f6FFF] hover:text-white transition-all">Edit</button>

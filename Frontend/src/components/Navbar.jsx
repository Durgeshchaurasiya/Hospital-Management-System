  ...
  return (
    <div className="flex items-center justify-between text-sm py-4 mb-5 border-b border-b-gray-400">
      ...
      <ul className="hidden md:flex items-start gap-5 font-medium">
        ...
        <a href="https://prescriptoadminpage.netlify.app/" target="_blank" className=" w-25 h-10 flex justify-center items-center pb-1  border border-blue-400 text-lg font-medium rounded-full hover:scale-105 hover:bg-[#5f6FFF] hover:text-white transition-all duration-200 cursor-pointer">Admin</a>
      </ul>
      <div className="flex items-center gap-4">
        ...
        <div className={`${showMenu ? 'fixed w-full' : 'h-0 w-0'} md:hidden right-0 top-0 bottom-0 z-20 overflow-hidden bg-white transition-all`}>
          ...
          <ul className="flex flex-col items-center gap-2 mt-5 px-5 text-lg font-medium">
            ...
            <a href="https://prescriptoadminpage.netlify.app/" target="_blank" className="px-4 py-2 rounded inline-block ">Admin</a>
          </ul>
        </div>
      </div>
    </div>

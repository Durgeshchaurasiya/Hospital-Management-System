  ...
  return (
    <div>
      ...
      <div className="flex flex-col sm:flex-row items-start gap-5 mt-5">
        ...
        <button className={`py-2 px-3 border rounded text-sm transition-all sm:hidden ${showFilters ? 'bg-[#5f6FFF] text-white' : ''}`} onClick={() => setShowFilters(prev => !prev)}>Filters</button>
